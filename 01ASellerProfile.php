				...
				<div class="navbar-right">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						...
						<ul class="nav navbar-nav">
                                                    ...
                                                    <li><a href="products.php">Contacts</a></li>
		...
		<div class="ad-post-wrapper section">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
                                            <?php
                                            if(isset($_SESSION['v_update']))
                                            {
                                                echo $_SESSION['v_update'];
                                                unset($_SESSION['v_update']);
                                            }
                                            ?>
                                            <form  class="form-group" action="01ASellerUpdate.php" method="post">
                                                <input type="hidden" name="id" value="<?php echo $id;?>"/>
                                                <table border="1" style="width: 100%; color: blue;font-weight: bold;font-size: large;" class="table">
                                                    <tr>
                                                        <td colspan="2">
                                                            <input type="submit" value="Update Status" class="form-control btn-success" style="color: white;font-weight: bold;"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Status</td>
                                                    ...
                                                    <tr>
                                                        <td>Name</td>
                                                        <td><input type="text" disabled="true" name="name" value="<?php echo $r['name'];?>" class="form-control"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Age</td>
                                                        <td><input type="text" disabled="true" name="age" value="<?php echo $r['age'];?>" class="form-control"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email</td>
