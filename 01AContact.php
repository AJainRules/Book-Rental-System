				...
				<div class="navbar-right">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
                                                    ...
                                                    <li class="active"><a href="01AContact.php">Contacts</a></li>
							...
							<div id="category-tab">
								...
								<div class="category-tab">
									...
									<!-- Tab panes -->
                                                                        <h2>
                                                                        <?php
                                                                        if(isset($_SESSION['con_del']))
                                                                        {
                                                                            echo $_SESSION['con_del'];
                                                                            unset($_SESSION['con_del']);
                                                                        }
                                                                        ?>
                                                                        </h2>
								    	...
								    	<div role="tabpanel" class="tab-pane active" id="recent">
                                                                                ...
                                                                                <table  border="1" style="width: 100%; font-weight: bold; font-size: large;">
                                                                                    <tr style="color: darkblue;">
                                                                                        <th>Sr.</th><th>Name</th><th>Email</th><th>Mobile</th><th>Message</th><th>Option</th>
                                                                                    </tr>
                                                                                    <?php
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><textarea class="form-control" disabled="true"><?php echo $r['message'];?></textarea></td>
                                                                                        <td><a href="contactDelete.php?cid=<?php echo $r['cid'];?>">Delete</a></td>
                                                                                    </tr>
                                                                                    <?php
                                                                                    $i++;
                                                                                    }
